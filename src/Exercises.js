...
const exercises = {
  ...
  3: {
    1: {
      ...
      machine: [300, 90, 90, 180, 180, 90, 90, 180, 180]
    },
    2: {
      human: 'Brisk five-minute warmup walk, then do two repetitions of ' +
      'the following: Jog 200 yards (or 90 seconds). Walk 200 yards (or 90 seconds). ' +
  ...
  6: {
    1: {
      ...
      machine: [300, 300, 180, 480, 180, 300]
    },
    2: {
      human: 'Brisk five-minute warmup walk, then: Jog 1 mile (10 minutes). Walk 1/4 mile (or 3 minutes). ' +
      'Jog 1 mile (or 10 minutes)',
      machine: [300, 600, 180, 600]
    },
    3: {
